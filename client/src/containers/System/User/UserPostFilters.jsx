...
const UserPostFilters = ({ filters, setFilters, provinces, districts, handleApplyFilters }) => {
  return (
    <div className="grid grid-cols-1 gap-3 rounded-xl border border-gray-200 bg-white p-4 md:grid-cols-2 lg:grid-cols-5">
      <input
        type="text"
      ...
      <button onClick={handleApplyFilters} className="rounded-lg bg-blue-600 px-4 py-2 font-medium text-white text-sm">Lọc</button>
    </div>
  );
};
