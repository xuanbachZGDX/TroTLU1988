...
const PaymentResult = () => {
    ...
    if (loading) {
        return <div className="h-screen flex items-center justify-center">Đang xử lý kết quả thanh toán...</div>;
    }
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg text-center">
                {result?.code === '00' ? (
                    ...
                    <div>
                        ...
                        <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Giao dịch thất bại</h2>
                        <p className="mt-2 text-sm text-gray-600">{result?.msg || "Giao dịch không thành công hoặc đã bị hủy."}</p>
                    </div>
                )}
