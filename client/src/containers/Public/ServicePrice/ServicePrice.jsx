...
const ServicePrice = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-10 py-10 px-4 bg-gray-50">
      ...
      <div className="w-full max-w-[1100px]">
        <h2 className="text-2xl font-bold mb-8 text-blue-800 uppercase text-center">
          So sánh giao diện các loại tin đăng
        </h2>
                ...
                <div className="bg-white p-2 rounded-lg shadow-sm border border-dashed border-gray-300">
                  {examplePost ? (
                    <Item
                      ...
                      images={(() => {
                        ...
                        try {
                          ...
                          return Array.isArray(examplePost.images?.image)
                            ? examplePost.images?.image
                            : [];
                        }
                      })()}
                    ...
                    <div className="p-10 text-center text-gray-400 italic bg-gray-50 rounded-lg">
                      Hiện tại chưa có tin đăng mẫu cho gói {item.name} trong hệ
                      thống.
                    </div>
                  )}
                </div>
      ...
      <div className="w-full max-w-[1100px] text-center text-gray-500 text-sm mt-4">
        <p>
          * Hệ thống thanh toán VIP và tính phí được đồng bộ trực tiếp với cơ sở
          dữ liệu cấu hình.
        </p>
      </div>
    </div>
